namespace EGID.Application.Common
{
    public static class Regexes
    {
        ...
        /// <summary>
        ///     Represent username where allowed character is a to z, 0 to 9, _, -
        ///     and minimum of 3 characters and maximum of 50.
        /// </summary>
        public const string UserName = "^[a-z0-9_.-]{3,50}[[a-z0-9]$";
        ...
        /// </summary>
        public const string HttpUrl = @"^((https?):\/\/)?(www\.)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?$";
        ...
        public const string InternationalPhone =
            @"^(?:(?:\(?(?:00|\+)([1-4]\d\d|[1-9]\d?)\)?)?[\-\.\ \\\/]?)?((?:\(?\d{1,}\)?[\-\.\ \\\/]?){0,})(?:[\-\.\ \\\/]?(?:#|ext\.?|extension|x)[\-\.\ \\\/]?(\d+))$";

        // public const string ArabicName = @"[\u0600-\u06ff]|[\u0750-\u077f]|[\ufb50-\ufbc1]|[\ufbd3-\ufd3f]|[\ufd50-\ufd8f]|[\ufd92-\ufdc7]|[\ufe70-\ufefc]|[\uFDF0-\uFDFD]";

        // public const string EnglishArabicName = @"[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z]+[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z-_]*";
    }
}