...
export class CardClient {
  ...
  isCorrectPin2(command: IsCorrectPin2Query): Observable<boolean> {
    let url_ = this.baseUrl + "/api/card/iscorrectpin2";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http
      ...
      .pipe(
        _observableMergeMap((response_: any) => {
          return this.processIsCorrectPin2(response_);
        })
      )
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processIsCorrectPin2(<any>response_);
            } catch (e) {
  ...
  protected processIsCorrectPin2(
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return <Observable<CitizenDetailsVm[]>>(
...
export class HealthInfoClient {
  ...
  protected processEmergencyPhones(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
export class SignatureClient {
  ...
  sign(command: SignHashCommand): Observable<FileResponse> {
  ...
  protected processSign(response: HttpResponseBase): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return <Observable<VerifySignatureResult>>(
                (<any>_observableThrow(e))
              );
            }
          } else
...
export class CreateCardCommand implements ICreateCardCommand {
  ...
  init(_data?: any) {
    if (_data) {
      this.ownerId =
        _data["ownerId"] !== undefined ? _data["ownerId"] : <any>null;
...
export class ChangePukCommand implements IChangePukCommand {
  ...
  init(_data?: any) {
    if (_data) {
      this.cardId = _data["cardId"] !== undefined ? _data["cardId"] : <any>null;
      this.currentPuk =
        _data["currentPuk"] !== undefined ? _data["currentPuk"] : <any>null;
  ...
  toJSON(data?: any) {
    ...
    data["cardId"] = this.cardId !== undefined ? this.cardId : <any>null;
    data["currentPuk"] =
      this.currentPuk !== undefined ? this.currentPuk : <any>null;
...
export class ChangePin1Command implements IChangePin1Command {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.puk = _data["puk"] !== undefined ? _data["puk"] : <any>null;
      this.newPin1 =
        _data["newPin1"] !== undefined ? _data["newPin1"] : <any>null;
    }
  }
...
export class ChangePin2Command implements IChangePin2Command {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.puk = _data["puk"] !== undefined ? _data["puk"] : <any>null;
      this.newPin2 =
        _data["newPin2"] !== undefined ? _data["newPin2"] : <any>null;
    }
  }
...
export class IsCorrectPin2Query implements IIsCorrectPin2Query {
  pin2!: string;

  constructor(data?: IIsCorrectPin2Query) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
  ...
  static fromJS(data: any): IsCorrectPin2Query {
    data = typeof data === "object" ? data : {};
    let result = new IsCorrectPin2Query();
    result.init(data);
    return result;
  }
...
export interface IIsCorrectPin2Query {
  pin2: string;
}
...
export class AuditableEntity implements IAuditableEntity {
  ...
  init(_data?: any) {
    if (_data) {
      this.create = _data["create"]
        ? new Date(_data["create"].toString())
        : <any>null;
      this.createBy =
        _data["createBy"] !== undefined ? _data["createBy"] : <any>null;
      this.lastModified = _data["lastModified"]
        ? new Date(_data["lastModified"].toString())
        : <any>null;
      this.lastModifiedBy =
        _data["lastModifiedBy"] !== undefined
          ? _data["lastModifiedBy"]
          : <any>null;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["lastModified"] = this.lastModified
      ...
      : <any>null;
    data["lastModifiedBy"] =
      this.lastModifiedBy !== undefined ? this.lastModifiedBy : <any>null;
    return data;
  }
}
...
export class CitizenDetailsVm extends AuditableEntity
  implements ICitizenDetailsVm {
  id?: string | null;
  ...
  init(_data?: any) {
    ...
    if (_data) {
      ...
      this.fatherId =
        _data["fatherId"] !== undefined ? _data["fatherId"] : <any>null;
      this.motherId =
        _data["motherId"] !== undefined ? _data["motherId"] : <any>null;
      this.fullName = _data["fullName"]
        ? FullName.fromJS(_data["fullName"])
        : <any>null;
      ...
      this.religion =
        _data["religion"] !== undefined ? _data["religion"] : <any>null;
      this.socialStatus =
        _data["socialStatus"] !== undefined ? _data["socialStatus"] : <any>null;
      this.dateOfBirth = _data["dateOfBirth"]
        ? new Date(_data["dateOfBirth"].toString())
        : <any>null;
      this.photoUrl =
        _data["photoUrl"] !== undefined ? _data["photoUrl"] : <any>null;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["socialStatus"] =
      this.socialStatus !== undefined ? this.socialStatus : <any>null;
...
export class FullName extends ValueObject implements IFullName {
  ...
  init(_data?: any) {
    ...
    if (_data) {
      ...
      this.secondName =
        _data["secondName"] !== undefined ? _data["secondName"] : <any>null;
      this.thirdName =
        _data["thirdName"] !== undefined ? _data["thirdName"] : <any>null;
      this.lastName =
  ...
  toJSON(data?: any) {
    ...
    data["secondName"] =
      this.secondName !== undefined ? this.secondName : <any>null;
    data["thirdName"] =
      this.thirdName !== undefined ? this.thirdName : <any>null;
...
export class CreateCitizenCommand implements ICreateCitizenCommand {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.photo = _data["photo"]
        ? BinaryFile.fromJS(_data["photo"])
        : <any>null;
      this.bloodType =
        _data["bloodType"] !== undefined ? _data["bloodType"] : <any>null;
      this.healthEmergencyPhone1 =
        _data["healthEmergencyPhone1"] !== undefined
          ? _data["healthEmergencyPhone1"]
          : <any>null;
      this.healthEmergencyPhone2 =
        _data["healthEmergencyPhone2"] !== undefined
          ? _data["healthEmergencyPhone2"]
          : <any>null;
      this.healthEmergencyPhone3 =
        _data["healthEmergencyPhone3"] !== undefined
          ? _data["healthEmergencyPhone3"]
          : <any>null;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["healthEmergencyPhone1"] =
      this.healthEmergencyPhone1 !== undefined
        ? this.healthEmergencyPhone1
        : <any>null;
    data["healthEmergencyPhone2"] =
      this.healthEmergencyPhone2 !== undefined
        ? this.healthEmergencyPhone2
        : <any>null;
    data["healthEmergencyPhone3"] =
      this.healthEmergencyPhone3 !== undefined
        ? this.healthEmergencyPhone3
        : <any>null;
    return data;
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.citizenName = _data["citizenName"]
        ? FullName.fromJS(_data["citizenName"])
        : <any>null;
      this.citizenPhoto =
...
export class HealthRecordVm implements IHealthRecordVm {
  ...
  init(_data?: any) {
    if (_data) {
      this.medications =
        _data["medications"] !== undefined ? _data["medications"] : <any>null;
      this.diagnosis =
        _data["diagnosis"] !== undefined ? _data["diagnosis"] : <any>null;
      this.create = _data["create"]
        ? new Date(_data["create"].toString())
        : <any>null;
      this.createBy =
  ...
  toJSON(data?: any) {
    data = typeof data === "object" ? data : {};
    data["medications"] =
      this.medications !== undefined ? this.medications : <any>null;
    data["diagnosis"] =
      this.diagnosis !== undefined ? this.diagnosis : <any>null;
    data["create"] = this.create ? this.create.toISOString() : <any>null;
    data["createBy"] = this.createBy !== undefined ? this.createBy : <any>null;
...
export class SignHashCommand implements ISignHashCommand {
  ...
  init(_data?: any) {
    if (_data) {
      this.pin2 = _data["pin2"] !== undefined ? _data["pin2"] : <any>null;
      this.fileName =
        _data["fileName"] !== undefined ? _data["fileName"] : <any>null;
      this.base64Sha512DataHash =
        _data["base64Sha512DataHash"] !== undefined
          ? _data["base64Sha512DataHash"]
          : <any>null;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["base64Sha512DataHash"] =
      this.base64Sha512DataHash !== undefined
        ? this.base64Sha512DataHash
        : <any>null;
    return data;
  }
    ...
    if (_data) {
      this.base64Sha512DataHash =
        _data["base64Sha512DataHash"] !== undefined
          ...
          : <any>null;
      this.signature =
        _data["signature"] !== undefined ? _data["signature"] : <any>null;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["base64Sha512DataHash"] =
      this.base64Sha512DataHash !== undefined
        ...
        : <any>null;
    data["signature"] =
      this.signature !== undefined ? this.signature : <any>null;
    return data;
  }
}
